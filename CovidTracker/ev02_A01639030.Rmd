...
Referencias:
Rabaan, A. (n.d). EMERGENCIA DE SARS-COV-2. ASPECTOS BÁSICOS SOBRE SU ORIGEN, EPIDEMIOLOGÍA, ESTRUCTURA Y PATOGENIA PARA CLÍNICOS. PubMed Central (PMC). https://pubmed.ncbi.nlm.nih.gov/32275259/
...
## Creamos un archivo fasta con todas las secuencias
```{r}
